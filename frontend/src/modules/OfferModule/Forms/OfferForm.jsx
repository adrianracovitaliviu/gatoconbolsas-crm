        ...
        <Col className="gutter-row" span={9}>
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: 'Introduzca un proveedor.',
              },
            ]}
          >
            <AutoCompleteAsync
        ...
        <Col className="gutter-row" span={5}>
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: 'Introduzca número de compra.',
              },
            ]}
          >
        ...
        <Col className="gutter-row" span={5}>
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: 'Introduzca año de compra.',
              },
            ]}
          >
          ...
          >
            <Select
              options={[
                ...
                { value: 'enviado', label: 'Comprado' },
                { value: 'aceptado', label: 'Cerrado' },
              ]}
            ></Select>
          </Form.Item>
        </Col>
