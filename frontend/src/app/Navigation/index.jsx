...
const SIDEBAR_MENU = [
  ...
  { key: '#', icon: <ShoppingCartOutlined />, title: 'Productos' },
  { key: '/customer', icon: <GroupOutlined />, title: 'Clientes' },
  { key: '/invoice', icon: <FileTextOutlined />, title: 'Facturación' },
  { key: '/quote', icon: <FileSyncOutlined />, title: 'Albaranes' },
  { key: '/payment/invoice', icon: <CreditCardOutlined />, title: 'Pagos' },
