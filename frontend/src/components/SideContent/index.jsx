  ...
  return (
    ...
    >
      <div style={{ width: '100%' }}>
        ...
        <Title level={3}>Administra tu empresa con :</Title>
        <div className="space20"></div>
        <ul className="list-checked">
          <li className="list-checked-item">
            <Space direction="vertical">
              <Text strong>CRM Avanzado</Text>

              <Text>Gestion de inventario, clientes y facturación</Text>
            </Space>
          </li>

          <li className="list-checked-item">
            <Space direction="vertical">
              <Text strong>Factura &amp; gestiona tu empresa</Text>
              <Text>Procesos automatizados de facturación y gestión de empresa</Text>
            </Space>
          </li>
        </ul>
        <Divider />
